...
public class ReportDesign extends VerticalLayout {
    protected VerticalLayout breadcrumbsLayout;
    protected Label projectLabel;
    protected Label arrowIconLabel;
    ...
    protected Panel reportDescriptionPanel;
    protected VerticalLayout reportDescriptionLayout;
